...
const Wind = ({ speed, direction }) => {
  ...
  return (
    <div className="bg-neutral-800 border-none rounded-2xl px-8 py-2 flex flex-col gap-2 h-full">
      <div className="flex gap-2 items-center">
        <WiStrongWind className="text-white" />
        <p className="text-white">Wind</p>
      </div>
      <div className="flex flex-col md:justify-between gap-2 text-center">
        <div>
